...
- first simulation-authoritative `Fix_It` kernel over component integrity: canonical program identity/directive, survival-first staged repair planning, material/energy/time estimates, and explicit Replacement -> Upgrade -> Redesign -> Evolution eligibility gates (implementation branch; fabrication/install, successor/lineage, and consciousness-transfer execution remain downstream);
