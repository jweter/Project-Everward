...
Current Phase 2 scope remains deliberately bounded to one probe: simulation time, canonical probe state, deterministic movement/scan integration, power and thermal behavior, probe-wide safety lockouts, initial per-subsystem operational state, and domain-event delivery. Failure causes and repair mechanics remain separate future slices; astronomy, industry, research, messages, lineage, and autonomous agency remain gated by later roadmap phases.
