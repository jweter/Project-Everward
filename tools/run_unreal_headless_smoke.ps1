...
$Arguments = @("`"$ProjectPath`"", "-game", "-NullRHI", "-Unattended", "-NoSplash", "-NoSound", "-NoP4", "-NoAutoSDK", "-EverwardHeadlessSmokeSeconds=10", "-TestExit=`"Automation Test Queue Empty`"", "-log=`"$LogPath`"")
