...
def adapt_lineage_evidence(evidence: Mapping[str, Any]) -> dict[str, Any]:
    """Shape authoritative parent/successor lineage evidence for mobile review."""

    return _adapt_authoritative_evidence(
        evidence,
        component_name="Lineage/Evolution",
        default_label="Parent and successor lineage state",
    )
...
def adapt_manipulator_evidence(evidence: Mapping[str, Any]) -> dict[str, Any]:
    """Shape authoritative manipulator-state evidence for the mobile renderer."""

    return _adapt_authoritative_evidence(
        evidence,
        component_name="Manipulator",
        default_label="Manipulator state and interaction",
    )


def adapt_collision_damage_evidence(evidence: Mapping[str, Any]) -> dict[str, Any]:
    """Shape authoritative collision/damage evidence for the mobile renderer."""

    return _adapt_authoritative_evidence(
        evidence,
        component_name="Collision/Damage",
        default_label="Impact damage and subsystem consequences",
    )
...
def adapt_control_state_evidence(evidence: Mapping[str, Any]) -> dict[str, Any]:
    """Shape authoritative control/state-machine evidence for mobile review."""

    return _adapt_authoritative_evidence(
        evidence,
        component_name="Control State",
        default_label="Control and state-machine transition",
    )


def adapt_deterministic_replay_evidence(evidence: Mapping[str, Any]) -> dict[str, Any]:
    """Shape authoritative deterministic replay/seed evidence for mobile review."""

    return _adapt_authoritative_evidence(
        evidence,
        component_name="Deterministic Replay",
        default_label="Seeded replay identity and invariant state",
    )
