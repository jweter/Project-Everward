...
class Phase2TargetSelectionSurfaceTests(unittest.TestCase):
    ...
    def test_cmake_registers_target_selection_tests(self) -> None:
    ...
    def test_probe_runtime_wires_authoritative_selection_state(self) -> None:
        ...
        # Selection state lives in ProbeRuntime alongside the same
        # static_bodies_ registry the swept contact solver reads, not a
    ...
    def test_unreal_adapter_exposes_target_selection_surface_without_owning_it(self) -> None:
    ...
    def test_player_controller_exposes_select_nearest_target_input(self) -> None:
        ...
        self.assertIn("CommandSelectNearestTarget", self.controller_cpp)
    ...
    def test_controls_reference_documents_the_new_binding(self) -> None:
        self.assertIn("SELECT NEAREST PHYSICAL TARGET", self.hud_cpp)
