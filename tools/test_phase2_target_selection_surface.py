...
class Phase2TargetSelectionSurfaceTests(unittest.TestCase):
    ...
    def test_environment_registers_multiple_targets_at_different_ranges(self) -> None:
        ...
        # 5, not 3: Slice 12 ("resource/sample loop") added a fourth and
        # fifth registered body (SampleTargetId, SampleTarget2Id, see
        # test_phase2_manipulator_collection_surface.py) alongside the
        # bootstrap mining target and these two plain reference bodies.
        self.assertEqual(adapter_cpp.count("Core->add_static_sphere_body("), 5)
