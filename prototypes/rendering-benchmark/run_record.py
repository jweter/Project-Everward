"""Auditable raw run records for the Everward Unreal rendering benchmark."""
...
REQUIRED_TOP_LEVEL = {"record_version", "engine", "scenario_version", "scenario_name", "captured_at_utc", "capture"}
NUMERIC_NONNEGATIVE_FIELDS = {"cpu_frame_time_ms", "gpu_frame_time_ms", "peak_memory_mib", "implementation_hours", "build_size_mib"}
STRING_CAPTURE_FIELDS = ("engine_version", "os_version", "cpu_model", "gpu_model", "notes")
...
def validate_run_record(data: Mapping[str, Any], scenario: Mapping[str, Any]) -> None:
    ...
    if data["engine"] != PRODUCTION_ENGINE:
